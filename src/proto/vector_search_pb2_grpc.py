...
class VectorSearchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Insert = channel.unary_unary(
                '/vectorsearch.VectorSearch/Insert',
                request_serializer=vector__search__pb2.InsertRequest.SerializeToString,
                response_deserializer=vector__search__pb2.InsertResponse.FromString,
                _registered_method=True)
        self.Delete = channel.unary_unary(
                '/vectorsearch.VectorSearch/Delete',
                request_serializer=vector__search__pb2.DeleteRequest.SerializeToString,
                response_deserializer=vector__search__pb2.DeleteResponse.FromString,
                _registered_method=True)
...
def add_VectorSearchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Insert': grpc.unary_unary_rpc_method_handler(
                    servicer.Insert,
                    request_deserializer=vector__search__pb2.InsertRequest.FromString,
                    response_serializer=vector__search__pb2.InsertResponse.SerializeToString,
            ),
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=vector__search__pb2.DeleteRequest.FromString,
                    response_serializer=vector__search__pb2.DeleteResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'vectorsearch.VectorSearch', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('vectorsearch.VectorSearch', rpc_method_handlers)
...
class VectorSearch(object):
    ...
    def Insert(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vectorsearch.VectorSearch/Insert',
            vector__search__pb2.InsertRequest.SerializeToString,
            vector__search__pb2.InsertResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Delete(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vectorsearch.VectorSearch/Delete',
            vector__search__pb2.DeleteRequest.SerializeToString,
            vector__search__pb2.DeleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
